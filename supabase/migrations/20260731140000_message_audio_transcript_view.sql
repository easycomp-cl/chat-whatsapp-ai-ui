-- Expone audio_transcript en la vista messages (columna Prisma audioTranscript del backend).
...
SELECT
  ...
  -- Placeholder hasta que el backend aplique audioTranscript en Message.
  -- Ver migración 20260731140100_message_audio_transcript_column.sql
