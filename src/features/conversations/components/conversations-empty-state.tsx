...
export function ConversationsEmptyState() {
  return (
    <section className="flex h-full min-h-0 min-w-0 flex-1 flex-col items-center justify-center bg-[#f9fafc] text-center">
      ...
      <h2 className="text-xl font-semibold text-[#202022]">easycomp-chat-bot-manager Inbox</h2>
